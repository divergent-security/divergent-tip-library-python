...
job_input_classes = {
  ...
  "Certificate": {
      ...
      "signature.algorithm": basestring,
      "issuer": basestring,
      "created": basestring,
      "expires": basestring,
      "valid": bool,
...
job_output_classes = {
  "Netblock": {
    ...
    "registered.asn.country": (basestring, 'FreeForm'),
    "registered.asn.description": (basestring, 'FreeForm'),
    "registered.asn.registry": (basestring, 'FreeForm'),
    "registered.asn.cidr": (basestring, 'CIDR'),
    "registered.org.name": (basestring, 'FreeForm'),
    "registered.org.id": (basestring, 'FreeForm'),
    ...
    "registered.org.country": (basestring, 'FreeForm'),
    "registered.org.state": (basestring, 'FreeForm'),
    "registered.org.zip": (basestring, 'FreeForm')
  },
  "Domain": {
    "tags": (list, (basestring, 'Name')),
